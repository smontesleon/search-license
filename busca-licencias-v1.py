...
#sys.stdout =open("/home/sergioml/Descargas/ejercicios-phy/salida.txt", 'wt') # graba a u archivo de texto la salida.
#Colocar en la siguiente linea el path donde ponga la lista de licencias
f1 = open('/home/sergioml/Descargas/ejercicios-phy/texto.txt',encoding= 'ISO 8859-1') #lista de licencias
...
ejemplo_dir = '/home/sergioml/Descargas/00'
...
for x in range(0,len(ficheros)):
    ...
    #Colocar el path donde haya desempaquetado la informacion de licencias
    search_path= '/home/sergioml/Descargas/00/'+ carpeta+'/'
